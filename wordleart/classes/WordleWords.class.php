...
class WordleWords {
    ...
    /**
     * Gets a word from the dictionary that matches the pattern.
     *
     * @param string $word The word to match.
     * @param int $p1 Position 1 match or no match.
     * @param int $p2 Position 2 match or no match.
     * @param int $p3 Position 3 match or no match.
     * @param int $p4 Position 4 match or no match.
     * @param int $p5 Position 5 match or no match.
     */
    ...
    /**
     * Gets a word from the dictionary that matches the pattern, using a custom
     * dictionary.
     *
     * @param string $word The word to match.
     * @param int $p1 Position 1 match or no match.
     ...
     * @param int $p5 Position 5 match or no match.
     */
    public function getWordCustom(string $target_word, int $p1, int $p2, int $p3, int $p4, int $p5) : string {
        ...
        try {
            ...
            try {
                $stmtstr = "SELECT word from " . MY_DBTBLE_CUSTOM . " WHERE LENGTH(word) = 5";
