...
?>
                ...
                // Set options.
                var options = {title:'USA Daily Average (7D) : Since April 2020',
                    curveType: 'function',
                    height:500,
                    vAxis: { scaleType: 'log' },
                    legend: { position: 'top' },
...
?>
                ...
                // Set options.
                var options = {title:'England Daily Average (7D) : Since April 2020',
                    curveType: 'function',
                    height:500,
                    vAxis: { scaleType: 'log' },
                    legend: { position: 'top' },
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/">Full History</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/recent.php">Last 3 Months</a>
                        </li>
                        <li class="nav-item">
